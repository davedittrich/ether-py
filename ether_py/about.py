...
class About(Command):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            ...
            dest='readthedocs',
            default=False,
            help=("Open a browser to the ``ether-py`` readthedocs page "
                  "(default: False{}).")
        )
    ...
    def take_action(self, parsed_args):
        if parsed_args.readthedocs:
            open_browser(page="https://ether-py.readthedocs.io",
            ...
            if (
                ...
                # Hacking formatting for `ether-py help` by adding a tab here.
                print(f'ether-py version { __version__ }\n{copyright()}')
